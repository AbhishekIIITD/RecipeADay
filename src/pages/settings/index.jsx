...
export default function Settings() {
    ...
    return ( <
        ...
        htmlFor = "vegNonVeg" > Diet Preference < /label> <
        select id = "vegNonVeg"
        name = "vegNonVeg"
        ...
        <
        label className = 'text-white md-3'
        htmlFor = "height" > Height( in cm): < /label> <
        input type = "number"
        id = "height"
        name = "height"
        ...
        <
        label className = 'text-white md-3'
        htmlFor = "weight" > weight( in KG): < /label> <
        input type = "number"
        id = "weight"
        name = "weight"
        ...
        <
        label className = ' text-white md-3'
        for = "healthIssue" > Select a Health Issue: < /label> <
        ...
        <
        label className = ' text-white md-3'
        for = "preferredCuisine" > Select Your Preferred Cuisine: < /label> <
        select type = "text"
        id = "cuisine"
        name = "cuisine"
